...
import 'piccolore';
import { r as renderTemplate, n as defineScriptVars, p as renderSlot, q as renderHead, h as addAttribute, o as renderComponent, v as Fragment, m as maybeRenderHead } from './entrypoint_D87tld0u.mjs';
import 'clsx';
...
const $$BaseLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { title = "FragLog.gg — Valorant VOD Library", description = "Watch Radiant and pro player Valorant gameplay VODs filtered by map and agent. Study the best players in the world on FragLog.gg", ogImage = "https://media.valorant-api.com/maps/7eaecc1b-4337-bbf6-6ab9-04b8f06b3319/splash.png", canonical = "https://fraglog.gg" } = Astro2.props;
  ...
  return renderTemplate(_a$1 || (_a$1 = __template$1(['<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>', '</title><meta name="description"', '><meta name="keywords" content="Valorant VODs, Radiant gameplay, pro player POV, Valorant tips, agent guide, map guide"><meta name="author" content="FragLog.gg"><meta name="robots" content="index, follow"><meta property="og:type" content="website"><meta property="og:url"', '><meta property="og:title"', '><meta property="og:description"', '><meta property="og:image"', '><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"', '><meta name="twitter:description"', '><meta name="twitter:image"', '><link rel="canonical"', '><script defer src="https://cdn.vercel-insights.com/v1/script.js"><\/script><script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"><\/script>', '</head> <body> <div id="map-bg-layer"></div> ', ` <!-- Auth Modal --> <div class="auth-modal-backdrop" id="auth-modal" onclick="closeAuthModal(event)"> <div class="auth-modal"> <h2>FragLog<span style="color:var(--red)">.gg</span></h2> <div class="auth-tabs"> <button class="auth-tab active" onclick="switchTab('login')">Sign In</button> <button class="auth-tab" onclick="switchTab('register')">Create Account</button> </div> <div class="auth-field"> <label>Email</label> <input type="email" id="auth-email" placeholder="you@example.com" autocomplete="email"> </div> <div class="auth-field"> <label>Password</label> <input type="password" id="auth-password" placeholder="••••••••" autocomplete="current-password"> </div> <div class="auth-field" id="confirm-field" style="display:none"> <label>Confirm Password</label> <input type="password" id="auth-confirm" placeholder="••••••••" autocomplete="new-password"> </div> <div class="auth-error" id="auth-error"></div> <button class="auth-btn primary" style="width:100%;padding:10px" onclick="submitAuth()">Sign In</button> </div> </div> <!-- Notes Modal --> <div class="notes-modal-backdrop" id="notes-modal" onclick="closeNotesModal(event)"> <div class="notes-modal"> <div class="notes-modal-header"> <div> <div class="notes-modal-title" id="notes-modal-title"></div> <div class="notes-modal-meta" id="notes-modal-meta"></div> </div> <button class="notes-modal-close" onclick="closeNotesDirect()">✕</button> </div> <div class="notes-modal-body"> <div class="notes-admin-box" id="notes-admin-box" style="display:none"> <div class="notes-admin-label">💡 Creator Note</div> <div class="notes-admin-text" id="notes-admin-text"></div> </div> <div class="notes-user-box"> <div class="notes-user-label">Your Notes</div> <textarea class="notes-textarea" id="notes-textarea" placeholder="Write anything — timestamps, things to study, key moments..."></textarea> </div> </div> <div class="notes-modal-footer"> <span class="notes-char-count" id="notes-char-count">0 characters</span> <div style="display:flex;align-items:center;gap:12px"> <span class="notes-saved-msg" id="notes-saved-msg">✓ Saved</span> <button class="notes-save-btn" onclick="saveNoteFromModal()">Save Notes</button> </div> </div> </div> </div> <!-- Nav right rendered server-side — no shift --> <script>(function(){`, `
  // Render nav immediately with server-known auth state
  (function() {
    // Nav right is rendered by Nav.astro using server data
    // This just sets up the global user state for client-side features
  ...
  async function initAuth() {
    ...
    // No renderNav needed — already rendered server-side
  }
  ...
  function openNotes(videoId, title, player, adminNote) {
    ...
    if (adminNote) {
      ...
      document.getElementById("notes-admin-text").textContent = adminNote;
    } else {
  ...
  <\/script> </body> </html>`], ['<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>', '</title><meta name="description"', '><meta name="keywords" content="Valorant VODs, Radiant gameplay, pro player POV, Valorant tips, agent guide, map guide"><meta name="author" content="FragLog.gg"><meta name="robots" content="index, follow"><meta property="og:type" content="website"><meta property="og:url"', '><meta property="og:title"', '><meta property="og:description"', '><meta property="og:image"', '><meta name="twitter:card" content="summary_large_image"><meta name="twitter:title"', '><meta name="twitter:description"', '><meta name="twitter:image"', '><link rel="canonical"', '><script defer src="https://cdn.vercel-insights.com/v1/script.js"><\/script><script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"><\/script>', '</head> <body> <div id="map-bg-layer"></div> ', ` <!-- Auth Modal --> <div class="auth-modal-backdrop" id="auth-modal" onclick="closeAuthModal(event)"> <div class="auth-modal"> <h2>FragLog<span style="color:var(--red)">.gg</span></h2> <div class="auth-tabs"> <button class="auth-tab active" onclick="switchTab('login')">Sign In</button> <button class="auth-tab" onclick="switchTab('register')">Create Account</button> </div> <div class="auth-field"> <label>Email</label> <input type="email" id="auth-email" placeholder="you@example.com" autocomplete="email"> </div> <div class="auth-field"> <label>Password</label> <input type="password" id="auth-password" placeholder="••••••••" autocomplete="current-password"> </div> <div class="auth-field" id="confirm-field" style="display:none"> <label>Confirm Password</label> <input type="password" id="auth-confirm" placeholder="••••••••" autocomplete="new-password"> </div> <div class="auth-error" id="auth-error"></div> <button class="auth-btn primary" style="width:100%;padding:10px" onclick="submitAuth()">Sign In</button> </div> </div> <!-- Notes Modal --> <div class="notes-modal-backdrop" id="notes-modal" onclick="closeNotesModal(event)"> <div class="notes-modal"> <div class="notes-modal-header"> <div> <div class="notes-modal-title" id="notes-modal-title"></div> <div class="notes-modal-meta" id="notes-modal-meta"></div> </div> <button class="notes-modal-close" onclick="closeNotesDirect()">✕</button> </div> <div class="notes-modal-body"> <div class="notes-admin-box" id="notes-admin-box" style="display:none"> <div class="notes-admin-label">💡 Creator Note</div> <div class="notes-admin-text" id="notes-admin-text"></div> </div> <div class="notes-user-box"> <div class="notes-user-label">Your Notes</div> <textarea class="notes-textarea" id="notes-textarea" placeholder="Write anything — timestamps, things to study, key moments..."></textarea> </div> </div> <div class="notes-modal-footer"> <span class="notes-char-count" id="notes-char-count">0 characters</span> <div style="display:flex;align-items:center;gap:12px"> <span class="notes-saved-msg" id="notes-saved-msg">✓ Saved</span> <button class="notes-save-btn" onclick="saveNoteFromModal()">Save Notes</button> </div> </div> </div> </div> <!-- Nav right rendered server-side — no shift --> <script>(function(){`, `
  // Render nav immediately with server-known auth state
  (function() {
    // Nav right is rendered by Nav.astro using server data
    // This just sets up the global user state for client-side features
  ...
  <\/script> </body> </html>`])), title, addAttribute(description, "content"), addAttribute(canonical, "content"), addAttribute(title, "content"), addAttribute(description, "content"), addAttribute(ogImage, "content"), addAttribute(title, "content"), addAttribute(description, "content"), addAttribute(ogImage, "content"), addAttribute(canonical, "href"), renderHead(), renderSlot($$result, $$slots["default"]), defineScriptVars({ user }));
}, "C:/Users/g3hol/fraglog/src/layouts/BaseLayout.astro", void 0);
...
const $$Nav = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$props, $$slots);
  Astro2.self = $$Nav;
  const { crumbs = [], user = null } = Astro2.props;
  return renderTemplate(_a || (_a = __template(["", '<nav> <a class="logo" href="/">FragLog<span>.gg</span></a> <div style="display:flex;align-items:center;gap:1rem"> <div class="breadcrumb"> ', ` </div> </div> <div class="nav-search-wrap"> <input type="text" id="nav-search" class="nav-search-input" placeholder="Search players, maps, agents..." autocomplete="off" oninput="handleNavSearch(this.value)" onfocus="if(this.value.trim() && window.location.pathname !== '/search') handleNavSearch(this.value)"> </div> <div class="nav-right" id="nav-right"> `, " </div> </nav> <script>\nfunction handleNavSearch(val) {\n  if (!val.trim()) return;\n  const url = '/search?q=' + encodeURIComponent(val.trim());\n  window.location.href = url;\n}\n<\/script>"])), maybeRenderHead(), crumbs.map((crumb, i) => renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${i > 0 && renderTemplate`<span class="sep">›</span>`}${crumb.href ? renderTemplate`<a class="crumb"${addAttribute(crumb.href, "href")}>${crumb.label}</a>` : renderTemplate`<span class="current">${crumb.label}</span>`}` })}`), user ? renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate` <button class="auth-btn" onclick="window.location='/favorites'">♥ Favorites</button> <button class="auth-btn" onclick="window.location='/my-vods'">My VODs</button> <div class="user-pill"> <div class="user-avatar">${user.email[0].toUpperCase()}</div> ${user.email.split("@")[0]} </div> <button class="auth-btn" onclick="signOut()">Sign Out</button> ` })}` : renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate` <button class="auth-btn" onclick="openAuth()">Sign In</button> <button class="auth-btn primary" onclick="openAuth('register')">Sign Up</button> ` })}`);
}, "C:/Users/g3hol/fraglog/src/components/Nav.astro", void 0);

const $$Footer = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<footer> <div class="footer-grid"> <div class="footer-brand"> <a class="logo" href="/">FragLog<span>.gg</span></a> <div class="footer-desc">Radiant &amp; pro player Valorant VODs filtered by map and agent. Study the best players in the world.</div> <div class="footer-disclaimer">Not affiliated with, endorsed by, or sponsored by Riot Games. Valorant and all related properties are trademarks of Riot Games, Inc.</div> </div> <div> <div class="footer-col-title">Navigate</div> <div class="footer-links"> <a class="footer-link" href="/">All Maps</a> <a class="footer-link" href="/favorites">Favorites</a> <a class="footer-link" href="/my-vods">My VODs</a> <a class="footer-link" href="/submit">Submit a VOD</a> </div> </div> <div> <div class="footer-col-title">Connect</div> <div class="footer-links"> <a class="footer-link" href="mailto:hello@fraglog.gg">Contact</a> </div> </div> <div> <div class="footer-col-title">Support</div> <div class="footer-links"> <a class="support-btn kofi" href="https://ko-fi.com/fraglog" target="_blank">☕ Ko-fi</a> </div> </div> </div> <div class="footer-bottom"> <span id="footer-year">© 2026 FragLog.gg — All rights reserved</span> <span>Made for the Valorant community</span> </div> </footer>`;
}, "C:/Users/g3hol/fraglog/src/components/Footer.astro", void 0);
...
const ROLES_ORDER = ["Duelist","Controller","Sentinel","Initiator"];
const ROLE_DOTS = {Duelist:"#FF8C42",Controller:"#4A9EFF",Sentinel:"#6BCF6B",Initiator:"#FF6B9D"};
...
function vodCount(mapId) {
  const m = VODS[mapId];
  if (!m) return 0;
  return Object.values(m).reduce((a, v) => a + v.length, 0);
}

function agentVods(mapId, agentId) {
...
export { $$BaseLayout as $, AGENTS as A, MAPS as M, ROLES_ORDER as R, $$Nav as a, $$Footer as b, agentVods as c, ROLE_DOTS as d, formatDate as f, getAllVods as g, vodCount as v };
